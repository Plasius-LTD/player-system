# Contributing to @plasius/player-system
...
`@plasius/player-system` provides non-rendering Player System orchestration contracts and helpers for Plasius game experiences.

Contributions typically fall into session-state contracts, preference-learning signals, module orchestration metadata, docs, tests, and tooling quality.
